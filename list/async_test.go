...
func TestAsyncProcess(t *testing.T) {
	...
	for _, tc := range []testcase{
		...
		},
		{
			...
			expected: stateUpdate{
				Elements: testElements[1:7],
				SerialToIndex: map[Serial]int{
					testElements[1].Serial(): 0,
					testElements[2].Serial(): 1,
					testElements[3].Serial(): 2,
					testElements[4].Serial(): 3,
					testElements[5].Serial(): 4,
					testElements[6].Serial(): 5,
				},
				CompactedSerials: []Serial{
					testElements[7].Serial(),
		...
		},
		{
			...
			load: testElements[:1],
			expected: stateUpdate{
				Elements: testElements[0:6],
				SerialToIndex: map[Serial]int{
					testElements[0].Serial(): 0,
					testElements[1].Serial(): 1,
					testElements[2].Serial(): 2,
					testElements[3].Serial(): 3,
					testElements[4].Serial(): 4,
					testElements[5].Serial(): 5,
				},
				CompactedSerials: []Serial{
					testElements[6].Serial(),
				},
			},
		},
		{
